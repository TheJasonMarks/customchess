...
export default function HomeScreen() {
  ...
  // iOS paid version = no ads, everything unlocked
  const isIOSPaid = Platform.OS === 'ios';
  const showAds = !isIOSPaid && !hasRemovedAds && !isPremium && !isSubscribed;
  ...
  return (
    <SafeAreaView style={[styles.container, { backgroundColor: theme.background }]}>
      ...
      <View style={styles.topBar}>
        {/* Hide Store button on iOS since it's a paid app */}
        {Platform.OS !== 'ios' && (
          <TouchableOpacity 
        ...
        {Platform.OS === 'ios' && <View style={styles.storeButton} />}
      ...
      >
        ...
        <View style={styles.menuContainer}>
          ...
          {/* Only show Online Play on non-iOS platforms */}
          {Platform.OS !== 'ios' && (
            <TouchableOpacity
